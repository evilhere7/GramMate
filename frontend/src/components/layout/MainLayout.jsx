  ...
  return (
    <div className="flex h-screen bg-black text-white overflow-hidden dark">
      ...
      <aside className="hidden md:flex flex-col w-64 border-r border-gray-800 bg-black h-full p-4">
        ...
        {isAuthenticated && (
          <div className="mt-auto p-4 bg-gradient-to-br from-gray-900 to-black border border-gray-800 rounded-2xl relative overflow-hidden">
            ...
            <Link to="/wallet" className="text-primary text-sm font-medium hover:underline mt-2 inline-block">
              View Wallet &rarr;
            </Link>
          </div>
        )}
